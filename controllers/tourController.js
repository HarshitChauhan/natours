...
exports.getToursWithin = catchAsync(async (req, res, next) =>  {
  ...
  const radius = unit === 'mi' ? distance / 3963.2 : distance / 6378.1; // mi or kms dividing distance by radius of earth
...
exports.getDistances = catchAsync(async (req, res, next) => {
  ...
  if (!lat || !lng) {
    next(new AppErrorHandler('Please provide latitutr and longitude in the format lat,lng.', 400));
  }
